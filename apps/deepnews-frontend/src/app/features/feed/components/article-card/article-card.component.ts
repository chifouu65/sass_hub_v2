...
export class ArticleCardComponent {
  ...
  getTagClass(tag: string): string {
      ...
      const categoryColors: Record<string, string> = {
          ...
          'crypto': 'bg-orange-50 text-orange-700 border-orange-200 hover:bg-orange-100',
          'cybersecurity': 'bg-slate-50 text-slate-700 border-slate-200 hover:bg-slate-100',
          ...
          'space': 'bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100',
          ...
          'entertainment': 'bg-fuchsia-50 text-fuchsia-700 border-fuchsia-200 hover:bg-fuchsia-100',
      ...
      return categoryColors[lowerTag] || 'bg-gray-50 text-gray-600 border-gray-200 hover:bg-gray-100';
  }
